...
export default function TeamPage() {
  ...
  const agents = [
    ...
    {
      id: "builder", role: "01 — РАЗРАБОТЧИК", name: "Builder Agent", emoji: "⚙️",
    ...
    {
      id: "designer", role: "02 — ДИЗАЙНЕР", name: "Designer Agent", emoji: "🎨",
    ...
    {
      id: "marketing", role: "03 — МАРКЕТИНГ", name: "Marketing Agent", emoji: "📣",
